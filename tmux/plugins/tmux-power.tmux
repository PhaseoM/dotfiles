...
if "$show_upload_speed"; then
    LS="$LS#[fg=$G2,bg=$G1]$rarrow#[fg=$TC,bg=$G1] $download_speed_icon #{download_speed} #[fg=$G1,bg=$G0]$rarrow"
else
...
if "$show_download_speed"; then
    RS="#[fg=$G1,bg=$G0]$larrow#[fg=$TC,bg=$G1]  #{cpu} |  #{mem} $RS"
fi
...
# tmux_set window-status-format "#[fg=$G0,bg=$G2]#[fg=$TC,bg=$G2] #I #W #[fg=$G2,bg=$G0]"
# tmux_set window-status-current-format "#[fg=$G0,bg=$TC]#[fg=$G0,bg=$TC,bold] #I #W #[fg=$TC,bg=$G0,nobold]"
